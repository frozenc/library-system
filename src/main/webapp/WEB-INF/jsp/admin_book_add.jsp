...
<div class="container" style="position: relative;top: 10%;width: 80%;margin-left: 10%;background-color: white; border-radius: 5px">
            <form action="book_add_do.html" method="post" id="addbook" style="padding-top: 20px" >
