...
<div class="panel panel-default" style="width: 90%;margin-left: 5%">
    <div class="panel-heading" style="background-color: #fff;height: 65px">
        <table class="table">
            <tbody>
            <tr>
                <td>
        ...
        <table class="table table-hover">
            ...
            <c:forEach items="${list}" var="alog">
                <tr>
                    ...
                    <td><a href="deletelendlist.html?lendlistId=<c:out value="${alog.sernum}"></c:out>"><button type="button" class="btn btn-danger btn-xs">删除</button></a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
