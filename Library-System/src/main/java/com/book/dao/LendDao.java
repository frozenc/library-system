...
public class LendDao {
    ...
    private final static String DELETE_LENDLIST_SQL="DELETE from lend_list where sernum = ?  ";
    ...
    public int deleteLendList(long lendlistId){
        return jdbcTemplate.update(DELETE_LENDLIST_SQL,lendlistId);
    }
